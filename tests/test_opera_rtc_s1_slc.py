    ...
    assert sorted(response, key=lambda x: x['name']) == [
        {
            'name': 'product1',
            'files': [
                {'name': 'product1.h5', 'type': 'data', 'uri': 's3://myBucket/myJobId/product1.h5',
                 'size': 12, 'checksum': 'd552', 'checksumType': 'md5'},
                {'name': 'product1.iso.xml', 'type': 'metadata', 'uri': 's3://myBucket/myJobId/product1.iso.xml',
                 'size': 13, 'checksum': 'f152', 'checksumType': 'md5'},
                {'name': 'product1_BROWSE.png', 'type': 'browse', 'uri': 's3://myBucket/myJobId/product1_BROWSE.png',
                 'size': 14, 'checksum': '725d', 'checksumType': 'md5'},
                {'name': 'product1_VV.tif', 'type': 'data', 'uri': 's3://myBucket/myJobId/product1_VV.tif',
                 'size': 15, 'checksum': '64c1', 'checksumType': 'md5'},
                {'name': 'product1_mask.tif', 'type': 'data', 'uri': 's3://myBucket/myJobId/product1_mask.tif',
                 'size': 16, 'checksum': '9e70', 'checksumType': 'md5'},
            ],
            'dataVersion': '1.0',
        },
        {
            'name': 'product2',
            'files': [
                {'name': 'product2.h5', 'type': 'data', 'uri': 's3://myBucket/myJobId/product2.h5',
                 'size': 17, 'checksum': 'e772', 'checksumType': 'md5'},
                {'name': 'product2.iso.xml', 'type': 'metadata', 'uri': 's3://myBucket/myJobId/product2.iso.xml',
                 'size': 18, 'checksum': 'b6b8', 'checksumType': 'md5'},
                {'name': 'product2_BROWSE.png', 'type': 'browse', 'uri': 's3://myBucket/myJobId/product2_BROWSE.png',
                 'size': 19, 'checksum': '662f', 'checksumType': 'md5'},
                {'name': 'product2_VV.tif', 'type': 'data', 'uri': 's3://myBucket/myJobId/product2_VV.tif',
                 'size': 20, 'checksum': '68ad', 'checksumType': 'md5'},
                {'name': 'product2_mask.tif', 'type': 'data', 'uri': 's3://myBucket/myJobId/product2_mask.tif',
                 'size': 21, 'checksum': 'fc90', 'checksumType': 'md5'},
            ],
            'dataVersion': '1.0',
        },
    ]
